    ...
    public class TabSubmenuItem : TabItem
    {
        ...
        public override void Draw()
        {
            ...
            for (int i = 0; i < Items.Count; i++)
            {
                ...
                new UIResText(Items[i].Title, SafeSize.AddPoints(new Point(6, 5 + (itemSize.Height + 3) * i)), 0.35f, Color.FromArgb(fullAlpha, (Index == i && Focused) ? Colors.Black : Colors.White)).Draw();
